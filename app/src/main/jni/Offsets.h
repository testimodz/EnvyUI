...
//  Source: libil2cpp.so (relative from base)
// ============================================================
...
namespace Toram {
    namespace Offsets {
        ...
        // Quest Items
        constexpr uintptr_t mqitem          = 55473764; // QuestItemCommon$$get_ItemNum
        constexpr uintptr_t eqitem          = 55480256; // MissionItemCommon$$get_ItemNum
        constexpr uintptr_t mqmob           = 55475256; // QuestMobCommon$$get_SubdueNum
        constexpr uintptr_t eqmob           = 55481740; // MissionMobCommon$$get_SubdueNum
